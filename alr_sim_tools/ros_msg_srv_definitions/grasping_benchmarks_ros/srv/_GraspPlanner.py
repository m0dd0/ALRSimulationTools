...
"""
    ...
    def serialize(self, buff):
        ...
        try:
            ...
            buff.write(
                _get_struct_3I().pack(
                    _x.depth_image.header.seq,
                    _x.depth_image.header.stamp.secs,
                    _x.depth_image.header.stamp.nsecs,
                )
            )
            ...
            _x = self
            buff.write(
                _get_struct_2I().pack(_x.depth_image.height, _x.depth_image.width)
            )
            ...
            _x = self
            buff.write(
                _get_struct_BI().pack(_x.depth_image.is_bigendian, _x.depth_image.step)
            )
            ...
            buff.write(
                _get_struct_3I().pack(
                    _x.camera_info.header.seq,
                    _x.camera_info.header.stamp.secs,
                    _x.camera_info.header.stamp.nsecs,
                )
            )
            ...
            _x = self
            buff.write(
                _get_struct_2I().pack(_x.camera_info.height, _x.camera_info.width)
            )
            ...
            _x = self
            buff.write(
                _get_struct_6IB3I().pack(
                    _x.camera_info.binning_x,
                    _x.camera_info.binning_y,
                    _x.camera_info.roi.x_offset,
                    _x.camera_info.roi.y_offset,
            ...
            _x = self.pointcloud_segmented.header.frame_id
            length = len(_x)
            if python3 or type(_x) == unicode:
                _x = _x.encode("utf-8")
                length = len(_x)
            ...
            buff.write(
                _get_struct_2I().pack(
                    _x.pointcloud_segmented.height, _x.pointcloud_segmented.width
                )
            )
            length = len(self.pointcloud_segmented.fields)
            buff.write(_struct_I.pack(length))
            for val1 in self.pointcloud_segmented.fields:
                _x = val1.name
                length = len(_x)
                if python3 or type(_x) == unicode:
                    _x = _x.encode("utf-8")
            ...
            buff.write(
                _get_struct_B2I().pack(
                    _x.pointcloud_segmented.is_bigendian,
                    _x.pointcloud_segmented.point_step,
                    _x.pointcloud_segmented.row_step,
                )
            )
            _x = self.pointcloud_segmented.data
            length = len(_x)
            # - if encoded as a list instead, serialize as bytes instead of string
            if type(_x) in [list, tuple]:
                buff.write(struct.Struct("<I%sB" % length).pack(length, *_x))
            ...
            buff.write(
                _get_struct_14dBh().pack(
                    ...
                    _x.view_point.pose.orientation.x,
    ...
    def deserialize(self, str):
        ...
        try:
            ...
            if python3:
                self.depth_image.header.frame_id = str[start:end].decode(
                    "utf-8", "rosmsg"
                )
            else:
            ...
            (
                _x.depth_image.height,
                _x.depth_image.width,
            ) = _get_struct_2I().unpack(str[start:end])
            start = end
            end += 4
            (length,) = _struct_I.unpack(str[start:end])
            ...
            if python3:
                self.camera_info.header.frame_id = str[start:end].decode(
                    "utf-8", "rosmsg"
                )
            else:
            ...
            (
                _x.camera_info.height,
                _x.camera_info.width,
            ) = _get_struct_2I().unpack(str[start:end])
            start = end
            end += 4
            (length,) = _struct_I.unpack(str[start:end])
            ...
            if python3:
                self.camera_info.distortion_model = str[start:end].decode(
                    "utf-8", "rosmsg"
                )
            else:
            ...
            if python3:
                self.pointcloud_segmented.header.frame_id = str[start:end].decode(
                    "utf-8", "rosmsg"
                )
            else:
                self.pointcloud_segmented.header.frame_id = str[start:end]
            _x = self
            start = end
            end += 8
            (
                _x.pointcloud_segmented.height,
                _x.pointcloud_segmented.width,
            ) = _get_struct_2I().unpack(str[start:end])
            start = end
            end += 4
            (length,) = _struct_I.unpack(str[start:end])
            self.pointcloud_segmented.fields = []
            for i in range(0, length):
                val1 = sensor_msgs.msg.PointField()
                start = end
                end += 4
                ...
                self.pointcloud_segmented.fields.append(val1)
            _x = self
            start = end
            end += 9
            (
            ...
            self.pointcloud_segmented.is_bigendian = bool(
                self.pointcloud_segmented.is_bigendian
            )
            start = end
            end += 4
            (length,) = _struct_I.unpack(str[start:end])
            ...
            self.pointcloud_segmented.data = str[start:end]
            _x = self
            start = end
            end += 13
            (
            ...
            if python3:
                self.view_point.header.frame_id = str[start:end].decode(
                    "utf-8", "rosmsg"
                )
            else:
    ...
    def deserialize_numpy(self, str, numpy):
        ...
        try:
            ...
            self.camera_info.D = numpy.frombuffer(
                str[start:end], dtype=numpy.float64, count=length
            )
            start = end
            end += 72
            self.camera_info.K = numpy.frombuffer(
                str[start:end], dtype=numpy.float64, count=9
            )
            start = end
            end += 72
            self.camera_info.R = numpy.frombuffer(
                str[start:end], dtype=numpy.float64, count=9
            )
            start = end
            end += 96
            self.camera_info.P = numpy.frombuffer(
                str[start:end], dtype=numpy.float64, count=12
            )
            _x = self
            start = end
            end += 37
